...
# 测试5个关键的 mismatch_ratio 值 (保留极值)
MISMATCH_RATIOS=(0.1 0.5 1.0 2.0 5.0)
...
do
    ...
    CUDA_VISIBLE_DEVICES=1 python /home/zheng/zheng/multimodal-fusion/alignment/run.py \
        ...
        --save_path /home/zheng/zheng/multimodal-fusion/alignment/results/ablation_mismatch_ratio/model_ratio_${RATIO}.pth \
        --num_workers 0 \
