...
# 测试不同学习率调度器对Gated MIL Detach模型性能的影响
# =============================================================================
...
echo "🔬 Starting Learning Rate Scheduler Ablation Study..."
echo "============================================================"
...
echo "------------------------------------------------------------"
EXP_CODE="ablation_lr_scheduler_fixed"
SPECIFIC_RESULTS_DIR="${RESULTS_DIR}/ablation_lr_scheduler_fixed"
...
echo "------------------------------------------------------------"
EXP_CODE="ablation_lr_scheduler_cosine"
SPECIFIC_RESULTS_DIR="${RESULTS_DIR}/ablation_lr_scheduler_cosine"
mkdir -p "$SPECIFIC_RESULTS_DIR"
...
echo "------------------------------------------------------------"
EXP_CODE="ablation_lr_scheduler_cosine_restart"
SPECIFIC_RESULTS_DIR="${RESULTS_DIR}/ablation_lr_scheduler_cosine_restart"
mkdir -p "$SPECIFIC_RESULTS_DIR"
...
echo "------------------------------------------------------------"
EXP_CODE="ablation_lr_scheduler_step"
SPECIFIC_RESULTS_DIR="${RESULTS_DIR}/ablation_lr_scheduler_step"
mkdir -p "$SPECIFIC_RESULTS_DIR"
...
echo "------------------------------------------------------------"
EXP_CODE="ablation_lr_scheduler_plateau"
SPECIFIC_RESULTS_DIR="${RESULTS_DIR}/ablation_lr_scheduler_plateau"
mkdir -p "$SPECIFIC_RESULTS_DIR"
...
echo ""
echo "🎉 Learning Rate Scheduler Ablation Study completed!"
echo "============================================================"
echo "📊 Summary of experiments:"
echo "  - Fixed LR (baseline): ${RESULTS_DIR}/ablation_lr_scheduler_fixed"
echo "  - Cosine Annealing: ${RESULTS_DIR}/ablation_lr_scheduler_cosine"
echo "  - Cosine + Warm Restart: ${RESULTS_DIR}/ablation_lr_scheduler_cosine_restart"
echo "  - Step LR: ${RESULTS_DIR}/ablation_lr_scheduler_step"
echo "  - ReduceLROnPlateau: ${RESULTS_DIR}/ablation_lr_scheduler_plateau"
echo ""
